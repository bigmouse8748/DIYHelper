<template>
  ...
  >
    ...
    <el-form-item label="Current Image" v-if="formData.image_url">
      <div class="image-preview">
        ...
        <div class="image-info">
          <p><strong>Tip:</strong> You can update the image URL above if the current image is not displaying correctly or if you want to use a better quality image.</p>
        </div>
      </div>
    </el-form-item>
